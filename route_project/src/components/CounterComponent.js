import React, { useReducer } from "react"; // useReducer is a hook
...
const CounterComponent = () => {
  const [state, dispatch] = useReducer(countReducer, { count: 0 }); // 2 arguments 1st reducer function, 2nd initial state 
